# SP2Cat
An adapted version of the colabcat from someshkar, made specifically for the Student Project 2 - Cracking WiFi Passwords. Focousing on the -m 22000 (WPA-PBKDF2-PMKID+EAPOL) hash with the ability to resume sessions.
